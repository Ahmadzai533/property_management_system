    ...
    <div className="mx-auto max-w-7xl px-2 sm:px-2 lg:px-2">
        ...
        <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-white/80">
              Enterprise expense oversight, approvals, and accountable vendor
              payments.
            </p>
          </div>
      ...
      <div className="mt-6">
        <ExpenseFilters
          onSearch={() => {}}
          onReset={() => {}}
          onExport={() => toast.info("Exported expense report")}
          onPrint={() => toast.info("Printing expenses")}
          onRefresh={() => toast.info("Refreshed expenses")}
          onToggleAdvanced={() => toast.info("Advanced filters ready")}
        />
      </div>
          ...
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Review expenses, approvals, and payment workflows.
              </p>
            </div>
