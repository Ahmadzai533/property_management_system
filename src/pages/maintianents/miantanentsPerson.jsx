        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              <div><span className="text-slate-500 dark:text-slate-400 text-sm">Email:</span> <p className="font-medium">{data.email}</p></div>
              <div><span className="text-slate-500 dark:text-slate-400 text-sm">Phone:</span> <p className="font-medium">{data.phone}</p></div>
              <div><span className="text-slate-500 dark:text-slate-400 text-sm">Experience:</span> <p className="font-medium">{data.experience}</p></div>
              <div><span className="text-slate-500 dark:text-slate-400 text-sm">Jobs Completed:</span> <p className="font-medium">{data.jobs}</p></div>
              <div><span className="text-slate-500 dark:text-slate-400 text-sm">Status:</span> <Badge variant={statusColors[data.status] || 'default'}>{data.status}</Badge></div>
              <div><span className="text-slate-500 dark:text-slate-400 text-sm">Availability:</span> <Badge variant={availabilityColors[data.availability] || 'default'}>{data.availability}</Badge></div>
              <div className="col-span-2"><span className="text-slate-500 dark:text-slate-400 text-sm">Skills:</span> {data.skills.map(s => <Badge key={s} variant={skillColors[s] || 'default'} className="mr-1">{s}</Badge>)}</div>
            </div>
