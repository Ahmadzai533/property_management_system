...
const OwnProperties = () => {
  ...
  const breadcrumbItems = useMemo(() => [
    ...
    { label: t('properties.ownProperties', 'Own Properties'), path: '/properties/own', active: true },
  ], [t]);
        ...
        <div className="rounded-2xl bg-gradient-to-r bg-[#6D28D9]  p-5 text-white shadow-lg dark:from-[#6D28D9] dark:to-[#8B5CF6]">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold">{t('properties.ownProperties', 'Own Properties')}</h1>
                <p className="text-white/80 mt-0.5">{t('properties.ownPropertiesDesc', 'Manage and monitor your entire property portfolio')}</p>
              </div>
            </div>
          ...
          <div className="flex flex-wrap gap-2 mt-3 pt-3 border-t border-white/20">
            ...
            >
              ...
              {t('properties.listedProperties', 'Listed Properties')}
            </button>
            {firstPropertyId && (
              <>
                <button
                ...
                >
                  ...
                  {t('properties.viewFirst', 'View First')}
                </button>
                <button
                ...
                >
                  ...
                  {t('properties.editFirst', 'Edit First')}
                </button>
              </>
            )}
          </div>
                ...
                {viewMode === 'table' ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
                    <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                      {t('properties.gridViewComingSoon', 'Grid view coming soon...')}
                    </div>
                  </div>
                )}
              </motion.div>
