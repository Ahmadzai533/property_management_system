    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">{t('properties.propertyNotFoundDesc', "The property you're trying to edit doesn't exist.")}</p>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <button
                ...
                aria-label={t('properties.backToProperty', 'Back to Property')}
              >
                <ArrowLeft className="h-5 w-5" />
              </button>
              <div>
                <h1 className="text-2xl font-bold">{t('properties.editProperty', 'Edit Property')}</h1>
                <p className="text-white/80 mt-0.5">{t('properties.editPropertyDesc', 'Update the details for')} {property.name}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {isSubmitting ? t('common.updating', 'Updating...') : t('properties.updateProperty', 'Update Property')}
              </button>
            </div>
          </div>
        </div>
