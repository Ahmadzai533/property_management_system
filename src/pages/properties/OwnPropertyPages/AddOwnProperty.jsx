        ...
        <div className="rounded-2xl bg-gradient-to-r bg-[#6D28D9]  p-5 text-white shadow-lg dark:from-[#6D28D9] dark:to-[#8B5CF6]">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold">{t('properties.addProperty', 'Add New Property')}</h1>
                <p className="text-white/80 mt-0.5">{t('properties.addPropertyDesc', 'Fill in the details to add a new property to your portfolio')}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {isSubmitting ? t('common.saving', 'Saving...') : t('properties.saveProperty', 'Save Property')}
              </button>
            </div>
          </div>
        </div>
