...
import { 
  ChevronLeft, Edit, Archive, Trash2, 
  Home, Users, DollarSign, Calendar, 
  Square, Bed, Bath, Key, AlertCircle,
  Phone, Mail, FileText, Clock, Package
} from 'lucide-react';
...
const UnitDetails = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: unit?.unitNumber ? `Unit ${unit.unitNumber}` : 'Unit Details', active: true },
  ];
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">The unit you're looking for doesn't exist.</p>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white/80 mt-0.5">{unit.propertyName} • {unit.type}</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Unit Information</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Unit Number</p>
                    <p className="text-gray-900 dark:text-white font-medium">{unit.unitNumber}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Property</p>
                    <p className="text-gray-900 dark:text-white font-medium">{unit.propertyName}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Unit Type</p>
                    <p className="text-gray-900 dark:text-white font-medium">{unit.type}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Floor</p>
                    <p className="text-gray-900 dark:text-white font-medium">{unit.floor}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Size</p>
                    <p className="text-gray-900 dark:text-white font-medium">{unit.size} sqft</p>
                  </div>
                  <div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Lease Status: {unit.leaseStatus}</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-semibold text-gray-900 dark:text-white">${unit.rent}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-500 dark:text-gray-400">Security Deposit</span>
                    <span className="text-sm font-semibold text-gray-900 dark:text-white">${unit.rent * 2}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-500 dark:text-gray-400">Maintenance Fee</span>
                    <span className="text-sm font-semibold text-gray-900 dark:text-white">${Math.round(unit.rent * 0.1)}</span>
                  </div>
                </div>
              </div>
